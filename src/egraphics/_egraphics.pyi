...
def acquire_vk_queue(
    require_graphics: bool, require_compute: bool, require_transfer: bool, require_present: bool, /
) -> VkQueue: ...
def release_vk_queue(queue: VkQueue, /) -> None: ...
